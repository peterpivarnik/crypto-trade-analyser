...
public interface CryptoRepository extends JpaRepository<Crypto, Long>, JpaSpecificationExecutor<Crypto> {
    ...
    void updateNextDayMaxPrice(@Param("maxValue") BigDecimal maxValue,
    ...
    void updateNext2DayMaxPrice(@Param("maxValue") BigDecimal maxValue,
                                @Param("symbol") String symbol,
                                @Param("from") Long from,
                                @Param("to") Long to);
    ...
    void updateNextWeekMaxPrice(@Param("maxValue") BigDecimal maxValue,
                                @Param("symbol") String symbol,
                                @Param("from") Long from,
                                @Param("to") Long to);
