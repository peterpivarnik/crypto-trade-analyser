...
public interface BinanceApiRestClient {
  ...
  /**
   * Returns all supported assets and whether or not they can be withdrawn.
   *
   * @return All the supported assets
   */
   ...
   */
  List<Candlestick> getCandlestickBars(String symbol,
   ...
   */
  List<Trade> getMyTrades(String symbol, String orderId);
   ...
   */
  WithdrawResult withdraw(String asset,
                          String address,
                          String amount,
                          String name,
                          String addressTag);
