...
@Entity
@Table(schema = "public", name = "crypto_5H")
@Cacheable
@Getter
@Setter
@ToString
@EqualsAndHashCode
public class Crypto5H implements CryptoResult {

    @Id
    @NotNull
    @SequenceGenerator(name = "generator__seq_crypto_id", schema = "public", sequenceName = "seq_crypto_5H_id")
