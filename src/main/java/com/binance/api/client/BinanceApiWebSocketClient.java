...
public interface BinanceApiWebSocketClient extends Closeable {
   ...
   * @return a {@link Closeable} that allows the underlying web socket to be closed.
   */
  Closeable onCandlestickEvent(String symbols,
   ...
   * @return a {@link Closeable} that allows the underlying web socket to be closed.
   */
  Closeable onUserDataUpdateEvent(String listenKey,
                                  BinanceApiCallback<UserDataUpdateEvent> callback);
   ...
   * Close.
   *
   * @deprecated This method is no longer functional. Please use the returned {@link Closeable} 
   */
  @Deprecated
  void close();
}
