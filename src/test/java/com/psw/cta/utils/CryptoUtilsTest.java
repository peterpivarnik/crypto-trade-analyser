...
class CryptoUtilsTest {
  ...
  void shouldThrowCryptoTraderExceptionWhenTickerWithSymbolNotExist() {
    ...
    CryptoTraderException thrownException = assertThrows(CryptoTraderException.class,
                                                         () -> getVolume(crypto.getSymbolInfo()
                                                                               .getSymbol(),
                                                                         tickers));
  ...
  void shouldReturnVolumeWhenVolumeIsProperlySet() {
    ...
    BigDecimal returnedVolume = getVolume(crypto.getSymbolInfo().getSymbol(), tickers);
  ...
  void shouldCalculatePreviousThreeMaxAverage() {
    ...
    BigDecimal
        lastThreeMaxAverage
        = calculatePreviousThreeHighAverage(fifteenMinutesCandleStickData);
  ...
  void shouldCalculateSumDiffsPercent() {
    ...
    BigDecimal sumDiffsPercent = calculateSumPercentageDifferences1h(fifteenMinutesCandleStickData,
                                                                     currentPrice);
  ...
  void shouldCalculateSumDiffsPercent10h() {
    ...
    BigDecimal sumDiffsPercent = calculateSumPercentageDifferences10h(fifteenMinutesCandleStickData,
                                                                      currentPrice);
