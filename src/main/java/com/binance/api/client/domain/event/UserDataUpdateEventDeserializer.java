...
public class UserDataUpdateEventDeserializer extends JsonDeserializer<UserDataUpdateEvent> {
  ...
  public UserDataUpdateEvent deserialize(JsonParser jp, DeserializationContext ctx)
    ...
    if (userDataUpdateEventType == ACCOUNT_UPDATE || userDataUpdateEventType == ACCOUNT_POSITION_UPDATE) {
      AccountUpdateEvent accountUpdateEvent = getUserDataUpdateEventDetail(json,
  ...
  /**
   * Returns UserDataUpdateEventDetail.
   *
